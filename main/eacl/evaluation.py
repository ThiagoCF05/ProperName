...
def run(std=True):
    ...
    if std:
        ...
        print 20 * '-'
        print 'String Distance: '
        print 'Random: ', mean_confidence_interval(general_random['string']), scipy.stats.bayes_mvs(general_random['string'])[0]
        print 'Siddharthan: ', mean_confidence_interval(general_siddharthan['string']), scipy.stats.bayes_mvs(general_siddharthan['string'])[0]
        print 'Deemter: ', mean_confidence_interval(general_deemter['string']), scipy.stats.bayes_mvs(general_deemter['string'])[0]
        print 'Bayes Random: ', mean_confidence_interval(general_bayes_random['string']), scipy.stats.bayes_mvs(general_bayes_random['string'])[0]
        print 'Bayes No Variation: ', mean_confidence_interval(general_bayes_no_variation['string']), scipy.stats.bayes_mvs(general_bayes_no_variation['string'])[0]
        print 'Bayes Variation: ', mean_confidence_interval(general_bayes_variation['string']), scipy.stats.bayes_mvs(general_bayes_variation['string'])[0]
        print 20 * '-'
        print 'Jaccard Distance: '
