...
def run(std=True):
    ...
    if std:
        ...
        print 20 * '-'
        print 'String Distance: '
        print 'Random: ', mean_confidence_interval(general_random['string']), scipy.stats.bayes_mvs(general_random['string'])[0], scipy.stats.norm.interval(0.95, loc=np.mean(general_random['string']), scale=np.mean(general_random['string']))
        print 'Siddharthan: ', mean_confidence_interval(general_siddharthan['string']), scipy.stats.bayes_mvs(general_siddharthan['string'])[0], scipy.stats.norm.interval(0.95, loc=np.mean(general_siddharthan['string']), scale=np.mean(general_siddharthan['string']))
        print 'Deemter: ', mean_confidence_interval(general_deemter['string']), scipy.stats.bayes_mvs(general_deemter['string'])[0], scipy.stats.norm.interval(0.95, loc=np.mean(general_deemter['string']), scale=np.mean(general_deemter['string']))
        print 'Bayes Random: ', mean_confidence_interval(general_bayes_random['string']), scipy.stats.bayes_mvs(general_bayes_random['string'])[0], scipy.stats.norm.interval(0.95, loc=np.mean(general_bayes_random['string']), scale=np.mean(general_bayes_random['string']))
        print 'Bayes No Variation: ', mean_confidence_interval(general_bayes_no_variation['string']), scipy.stats.bayes_mvs(general_bayes_no_variation['string'])[0], scipy.stats.norm.interval(0.95, loc=np.mean(general_bayes_no_variation['string']), scale=np.mean(general_bayes_no_variation['string']))
        print 'Bayes Variation: ', mean_confidence_interval(general_bayes_variation['string']), scipy.stats.bayes_mvs(general_bayes_variation['string'])[0], scipy.stats.norm.interval(0.95, loc=np.mean(general_bayes_variation['string']), scale=np.mean(general_bayes_variation['string']))
        print 20 * '-'
        print 'Jaccard Distance: '
